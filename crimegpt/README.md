...
2. **Document generation engine** — start with **2–3 documents done flawlessly**, not all 7.
   Recommended first three: **Purvani Chargesheet**, **Remand Request (Police Custody)**,
   **Seizure Receipt**. (Demo requires ≥2 live + ≥4 total auto-generated.)
...
- ❌ All 7 documents half-working — quality over quantity.
- ❌ Autonomous "final" legal documents — always **"AI-assisted draft for officer review."**
- ❌ IPC/CrPC references — use **BNS/BNSS/BSA** only.
